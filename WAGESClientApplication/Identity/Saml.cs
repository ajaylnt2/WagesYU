...
namespace Saml
{
	...
	public class Response
	{
		...
		{
			var node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='mail']/saml:AttributeValue", _xmlNameSpaceManager);
		...
		{
			var node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='givenName']/saml:AttributeValue", _xmlNameSpaceManager);
		...
		{
			var node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='sn']/saml:AttributeValue", _xmlNameSpaceManager);
		...
		{
			var node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='samAccountName']/saml:AttributeValue", _xmlNameSpaceManager);
			return node == null ? string.Empty : node.InnerText;
		}

		public string GetCountry()
		{
			var node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='c']/saml:AttributeValue", _xmlNameSpaceManager);
			return node == null ? null : node.InnerText;
		}
	...
	public class AuthRequest
	{
		...
		public string GetRedirectUrl(string samlEndpoint)
		{
			var queryStringSeparator = samlEndpoint.Contains("?") ? "&" : "?";
          			return samlEndpoint + queryStringSeparator + "SAMLRequest=" + HttpUtility.UrlEncode(GetRequest(AuthRequestFormat.Base64));
		}
	}
}
